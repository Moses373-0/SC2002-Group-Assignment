...
/**
 * Three difficulty levels with different enemy spawns.
 * Easy: 3 Goblins
 * Medium: 1 Goblin + 1 Wolf, then backup 2 Wolves
 * Hard: 2 Goblins, then backup 1 Goblin + 2 Wolves
 */
...
/**
 * A wave of enemies that spawn together.
 */
class SpawnWave {
